...
class BackendController extends MY_Controller
{
    ...
    public function __construct()
    {
        ...
        //Example data
        // Site name
        $this->data['sitename'] = 'Razer Portal';

        //Example data
        // Browser tab
        $this->data['site_title'] = ucfirst('Razer Portal');
    ...
    // Custom template function to load a the javascript file for each template
    protected function template2($template_name, $data, $return , $js = "")
    {
        if ($return === true) {
            $content  = $this->load->view('templates/header', $this->data);
            $content .= $this->load->view('templates/main_header', $this->data);
            ...
            $content .= $this->load->view('templates/footer', $this->data);
            if($js != ""){
               $content .= $this->load->view($js, $this->data);     
            }
            $content .= $this->load->view('templates/end_footer', $this->data);
