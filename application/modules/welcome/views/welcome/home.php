    ...
    <body class="home-page card  square scrollbar-deep-purple square thin">
        ...
        <div class="container ">
            <div class="header" ng-controller="IndexCtrl">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <h3 class="text-muted pull-right">SBE Portals | <span style="color:#4f7ba2;">We have moved...</span></h3>
                    </div>
                </div>
                <hr>
            </div> <!-- header -->
            ...
            <div ng-view>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h1  style="color:#fff;">We split up for portals</h1>
                    </div>
                    <div class="clear"></div>
                </div>
      ...
      <div class="card-body"> -->
                ...
                <div class="row">
					...
					<a href="<?php echo BASEURL; ?>rogers" target="_blank">
					 ...
					 <div class="col-sm-3">
					<a href="<?php echo BASEURL; ?>sbe_parts" target="_blank">
                    
                            <div id="moved-box-parts" class="moved-box">Sbe Parts</div>
                        </a>
                    </div>
					<div class="col-sm-3">
					...
					<div class="col-sm-3">
					<a href="<?php echo base_url();?>brs" target="_blank">
                    <div id="moved-box-can" class="moved-box">BRS Screening</div>
					</a>
                    </div>
					<div class="col-sm-3">
					<a href="<?php echo base_url();?>stopwatch" target="_blank">
                    <div id="moved-box-can" class="moved-box">Stopwatch</div>
					</a>
                    </div>
                    <div class="clear"></div>
                </div>
