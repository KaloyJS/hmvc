...
echo date('Y')-1; echo '-'.date('Y');
?> <a href="<?=base_url(); ?>">SBE Canada</a>.</strong> All rights
    reserved.
</footer>
...
<script src="<?php echo base_url(); ?>assets/backend/AdminLTE/dist/fullcalendar.min.js"></script>
...
<script src="<?=base_url()?>assets/backend/AdminLTE/bower_components/bootstrap-colorpicker/dist/js/ie10-viewport-bug-workaround.js"></script>
